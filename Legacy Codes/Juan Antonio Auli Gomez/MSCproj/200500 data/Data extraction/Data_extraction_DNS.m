...
%files)'
path='C:\Users\devil\OneDrive - Imperial College London\Documents\FYP\ExtractedData3\';  %HPC path
...
ft=20000:10:50000;   % flow time // file time
...
if prompt==1
    ...
    %% Sort sensors by location
        ...
        [X_sensors]=readmatrix([path 'XYZ_Internal_Table_table_24000.csv'],'Range','C:C'); % x coordinates of simulation
        [Y_sensors]=readmatrix([path 'XYZ_Internal_Table_table_24000.csv'], 'Range','D:D'); % y coordinates of simulation
        ...
        % extract the organised data
            ...
            x_plotting=Sort_U(1:end-1,1);
            y_plotting=Sort_U(1:end-1,2);
            
            
            U=Sort_U(1:end-1,3:end);
            V=Sort_V(1:end-1,3:end);
            %P=Sort_P(:,3:end);
            ...
            %     name= prompt('enter filename');
              % save([pathSAVE 'Griddata_HPC_200500_002TR20.mat'],'U','V','P','x_plotting','y_plotting','xq','yq');
               save([pathSAVE 'Griddata_50000v2.mat'],'U','V','x_plotting','y_plotting','xq','yq');
