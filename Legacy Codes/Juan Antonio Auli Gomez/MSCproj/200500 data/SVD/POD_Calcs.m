...
path='C:\Users\devil\OneDrive - Imperial College London\Documents\FYP\Save Test\';
pathPOD='C:\Users\devil\OneDrive - Imperial College London\Documents\FYP\MSCproj\200500 data\';
%load('C:\Users\devil\OneDrive - Imperial College London\Documents\FYP\MSCproj\cyl_geo.mat')
%load('\\icnas1.cc.ic.ac.uk\jaa21\Desktop\MSCproj\fishpoints_ORIG.mat')
%not using fish points 
load([path 'Griddata_100000']);
...
T=10050*dt:dt*r:100000*dt;% flow time
n=length(x_plotting);
...
xlabel('Mode $i$','fontsize',20,'interpreter','latex'); 
ylabel('$\lambda_{i}/\sum_{i=1}^{M}\lambda_i$','fontsize',20,'interpreter','latex'); 
...
snapshot = find(round(T,4) == 35000*0.01); % choose snapshot to compare
...
save([pathPOD 'POD_100000'],'a','phi','Y_mean','Y','lambda')