...
run('C:\Users\devil\OneDrive - Imperial College London\Documents\FYP\MSCproj\200500 data\supporting\Reconstructionv3.m')
...
% Y_ROMv2 = Y_ROM(QRsensors,:);
% 
% for i = 1:10
%     [PSD] = spectrum_analyser([Time',Y_ROMv2(i,:)'],1);
% end
% 
% for i = 1:10
%     [PSD] = spectrum_analyser([Time',a_e(i,:)'],1);
% end
% 
% for i = 1:10
%     [PSD] = spectrum_analyser([Time',a_e(i,:)'],1);
