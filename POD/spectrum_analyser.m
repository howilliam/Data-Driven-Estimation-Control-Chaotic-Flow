...
if want_plot ==  1
    ...
    xlabel('St','Interpreter','Latex','Fontsize',28);
    xlim([0 0.5]);
    
%         % frequency domain - Strouhal n
%     subplot(2,1,2);
%     plot(PSD(1,:)*0.005/0.66 ,PSD(2,:),'k','Linewidth',1);
%     title('PSD','Interpreter','Latex','Fontsize',14);
%     xlabel('$St \: (-)$','Interpreter','Latex','Fontsize',12);
%     xlim([0 0.5]);
end
